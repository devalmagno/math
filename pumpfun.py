def main():
    ...
    while True:
        ...
        print(f"Fee: {fee}")
        print(f"Amount to buy in ARB: {dx}")
        print(f"Amount to receive in PumpToken: {dy}")
        print(f"Amount in fees accumulated ($ARB): {value_in_fees}\n")
